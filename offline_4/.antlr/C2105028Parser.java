// Generated from /home/tawhidumar/Academics/CSE310-Compiler-Sessional/offline_4/C2105028Parser.g4 by ANTLR 4.13.1
...
public class C2105028Parser extends Parser {
	...
	public ATN getATN() { return _ATN; }
	    ...
	    //generate unique_label
	    std::string new_label()
	    {
	        return "L" + std::to_string(label_count++);
	    }
	    std::string get_var_address(const std::stirng& id)
	    {
	        symbol_info* info = st.lookup(id);
	        if(info)
	        {
	            return info->get_asm_name();
	        }
	        return "Unknown_var";
	    }
		...
		try {
			...
			case 1:
				...
				((Compound_statement_for_funcContext)_localctx).rc = match(RCURL);
				        ...
				        ((Compound_statement_for_funcContext)_localctx).flag =  true;
			...
			case 2:
				...
				((Compound_statement_for_funcContext)_localctx).rc = match(RCURL);
				        ...
				        ((Compound_statement_for_funcContext)_localctx).flag =  false;
	...
	public final Factor_errContext factor_err() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1463812096L) != 0)) ) {
